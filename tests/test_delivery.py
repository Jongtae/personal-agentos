...
class DeliveryTests(unittest.TestCase):
    ...
    def test_closed_ux05_state_reconciles_to_documented_mp2_next_goal(self):
        ...
        self.assertEqual(result['next_goal']['id'],'D-MP2-03')
    ...
    def test_ux_plan_requires_each_predecessor(self):
        ...
        expected=('MP1-I-01','MP1-D-02','MP1-I-02','MP1-D-03','MP1-I-03','MP1-D-04','MP1-I-04','MP1-D-05','MP1-I-05','MP1-D-06','MP1-I-06','MP1-R-01','MP1-R-02','MP1-R-03','MP1-R-04','MP1-R-05','D-MP2-01','I-MP2-01','D-MP2-02','I-MP2-02')
