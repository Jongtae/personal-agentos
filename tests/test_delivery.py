...
class DeliveryTests(unittest.TestCase):
    ...
    def test_closed_ux05_state_reconciles_to_next_mp2_selection(self):
        ...
        self.assertEqual(result['next_goal']['id'],'OP-02')
        self.assertEqual(result['next_action'],'owner may configure the exact provider DNS allowlist and perform one operating deployment')
    ...
    def test_merged_documented_iteration_clears_active_state_and_exposes_review_gate(self):
        ...
        self.assertEqual(result['next_goal']['status'],'requires-explicit-owner-approval')
    ...
    def test_ux_plan_requires_each_predecessor(self):
        ...
        self.assertEqual(plan.select({'completed':completed})['id'],'OP-02')
        completed.append('OP-02')
    ...
    def test_fully_completed_plan_clears_stale_current_iteration_metadata(self):
        ...
        self.assertEqual(self.controller(Runner()).status()['next_action'],'owner may configure the exact provider DNS allowlist and perform one operating deployment')
