...
[WU-01](https://github.com/Jongtae/personal-agentos/issues/285) and [WU-02](https://github.com/Jongtae/personal-agentos/issues/286) are complete. [WU-03](https://github.com/Jongtae/personal-agentos/issues/287) is complete through merged [PR #288](https://github.com/Jongtae/personal-agentos/pull/288): the product package and web assets now use `src/personal_agent/`, with packaging, scripts, Docker, CI, tests, and evidence records aligned. WU-04 remains for tool, deployment, and test-structure follow-up. This restructuring preserves existing CLI usage, persisted data format, approval boundaries, isolation boundaries, recovery behavior, the nested `agentos/` repository, and `.runtime/` owner data.
