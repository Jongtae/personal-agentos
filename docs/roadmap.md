...
Owner-authorized [#314](https://github.com/Jongtae/personal-agentos/issues/314) replaces the former core-path selector with a finite A → B → C program. AgentOS now treats owner files and folders as the material foundation and conversation/work as the experience: preserve originals, search and use approved material, save ordinary-file results, and reuse them after restart. Only A, [FILE-WS-A-01 / #318](file-workspace-first-experience-contract.en.md), is active: it aligns criteria and records the boundary before implementation. [#315](https://github.com/Jongtae/personal-agentos/issues/315) and [#316](https://github.com/Jongtae/personal-agentos/issues/316) are planned successors, not active work.
