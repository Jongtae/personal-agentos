...
Owner-authorized [#314](https://github.com/Jongtae/personal-agentos/issues/314) replaces the former core-path selector with a finite A → B → C program. AgentOS now treats owner files and folders as the material foundation and conversation/work as the experience: preserve originals, search and use approved material, save ordinary-file results, and reuse them after restart. A is merged; [FILE-WS-B-01 / #315](https://github.com/Jongtae/personal-agentos/issues/315) is implemented on the review PR, and only [FILE-WS-C-01 / #316](https://github.com/Jongtae/personal-agentos/issues/316) is active for evidence audit, independent review, and PR submission. Neither issue is closed until its reviewed PR is merged.
