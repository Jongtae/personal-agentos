...
MP2 is proposed for [conversation-first settings](master-plan-02-proposal.en.md). [D-MP2-01](d-mp2-01-conversation-settings-contract.en.md) is the active design iteration: conversation is the default intent surface for safe settings reads and preview/confirm changes, while a local Chrome Settings-like companion remains the manual, inspectable control surface. I-MP2-01 remains inactive until this design merges; this adds no runtime implementation or live connection claim.
