...
The original owner-approved operating deployment preparation cycle [#258](https://github.com/Jongtae/personal-agentos/pull/258) is historical only: its `v1.0.4` candidate claim was incorrect. [OP-02 / #261](https://github.com/Jongtae/personal-agentos/pull/261) corrected the isolation and recovery design with immutable commit `18538eabc00a20de64f4c5f5a6ac004aeda2469e`, isolated Codex/profile/owner-state containers, a one-use read-only MCP boundary, default-deny exact-DNS provider proxy, executable preflight, and atomic no-replay recovery fixtures. TOP-01 is complete in [#272](https://github.com/Jongtae/personal-agentos/pull/272): actual local credential-free Compose acceptance on runtime merge `410a003a1332ceb2ec6dd32a74146b0422ac1d42` proved build, HTTP health, recreation persistence, backup/restore, Telegram pairing exclusion, and cleanup. It did not configure or observe a provider, credential, live connection, Telegram activation, or operating deployment. TOP-02 current product integration regression is the next documented substep; provider allowlist configuration, official login, provider reachability, Telegram activation, and one owner operating deployment remain deferred owner operating-mode steps.
