...
[WU-01](https://github.com/Jongtae/personal-agentos/issues/285) and [WU-02](https://github.com/Jongtae/personal-agentos/issues/286) are complete. [WU-03](https://github.com/Jongtae/personal-agentos/issues/287) is complete through merged [PR #288](https://github.com/Jongtae/personal-agentos/pull/288), and WU-04 is complete through merged [PR #292](https://github.com/Jongtae/personal-agentos/pull/292): the product package and web assets use `src/personal_agent/`, while packaging, scripts, Docker, CI, tests, and a structural regression verifier are aligned. The remaining step is the final STRUCT-01 requirement-to-evidence closeout. This restructuring preserves existing CLI usage, persisted data format, approval boundaries, isolation boundaries, recovery behavior, the nested `agentos/` repository, and `.runtime/` owner data.
