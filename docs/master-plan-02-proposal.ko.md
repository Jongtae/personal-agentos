...
**상태: proposed.** MP1은 mock-contract evidence로 development complete이며, 소유자는 issue #230에서 대화 우선 설정을 다음 설계 마찰로 명시 선택했다. D-MP2-01이 활성 설계 iteration이고, I-MP2-01은 활성 상태가 아니며 D-MP2-01 merge 전 시작할 수 없다.
